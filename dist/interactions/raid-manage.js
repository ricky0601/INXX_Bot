...
function isRaidManager(interaction, scheduleCreatorId) {
    if (scheduleCreatorId != null && interaction.user.id === scheduleCreatorId)
        return true;
...
export async function handleRaidManageButton(interaction) {
...
export async function handleRaidManageDeleteButton(interaction) {
    const parsed = parseCustomId(interaction.customId);
    if (!parsed) {
...
//# sourceMappingURL=raid-manage.js.map