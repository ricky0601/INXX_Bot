...
export async function handleCharacterRegisterSelect(interaction) {
    ...
    try {
        ...
        const selectedCharacters = preview.characters.filter((character) => selectedNames.has(character.characterName));
...
//# sourceMappingURL=character-register.js.map